---
title: "Adaptive Memory Router (Self-Calibrating)"
sidebar_position: 4.4
displayed_sidebar: guideSidebar
---

Self-calibrating extension of [Memory Router](/features/memory-router). Derives the routing table from a workload-specific calibration dataset instead of relying on the LongMemEval-S Phase B presets.
...
- [Memory Router](/features/memory-router) — base primitive
- [Cognitive Pipeline](/features/cognitive-pipeline) — composition that uses MemoryRouter as the recall stage
- [Evaluation Framework](/features/evaluation-framework) — for collecting calibration data via your existing eval harness
