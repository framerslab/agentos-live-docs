---
title: "Ingest Router (Input-Stage Smart Orchestration)"
sidebar_position: 4.2
displayed_sidebar: guideSidebar
---

Input-stage smart orchestrator. Classifies incoming content and picks an ingest strategy: `raw-chunks`, `summarized`, `observational`, `fact-graph`, `hybrid`, or `skip`. The first stage of the [Cognitive Pipeline](/features/cognitive-pipeline).
...
- [Cognitive Pipeline](/features/cognitive-pipeline) — composition primitive
- [Memory Router](/features/memory-router) — recall stage sibling
- [Read Router](/features/read-router) — read stage sibling
- [Memory Operations](/features/memory-operations#auto-ingest-pipeline) — the underlying auto-ingest primitives this router orchestrates
- [Memory Document Ingestion](/features/memory-document-ingestion) — document-mode ingest pipeline
